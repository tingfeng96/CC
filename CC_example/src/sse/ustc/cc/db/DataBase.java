...
public class DataBase extends SQLiteOpenHelper {
	...
	private final static String[] TB_NAME = { "Mon", "Tue", "Wed", "Thur",
			"Fri", "Sat", "Sun" };
	...
	public void onCreate(SQLiteDatabase db) {
		...
		for (int i = 0; i < 7; i++) {
			String sql = "CREATE TABLE "
					+ TB_NAME[i]
					+ " (_id INTEGER primary key autoincrement,classes varchar(70),location varchar(70),"
	...
	public Cursor select(int i) {
		...
		Cursor cursor = db
				.query(TB_NAME[i], null, null, null, null, null, null);
		return cursor;
	}

	public long insert(int i, String cla, String loca, String tea, String zhou,
			String jie, String time1, String time2, String which) {
	...
	public void update(int i, int _id, String cla, String loca, String tea,
			String zhou, String jie, String time1, String time2, String which) {
		SQLiteDatabase db = DataBase.this.getWritableDatabase();
		String where = "_id = ?";
